import { Button, Card, Popover, PopoverContent, PopoverTrigger } from '@heroui/react';
...
const commentsData = [
  {
    id: 1,
    author: "Jose Floren",
    date: new Date().getTime() - 2 * 365 * 24 * 60 * 60 * 1000,
  ...
  },
  {
    ...
    date: new Date().getTime() - 9 * 30 * 24 * 60 * 60 * 1000,
    content:
  ...
  return (
    <Card className='p-4' radius='sm'>
      <div className="flex justify-between items-center my-3">
        <div className="font-semibold">Comments ({commentsData.length})</div>
        <div>
          <Popover
            showArrow
            offset={20}
